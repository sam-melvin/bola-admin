                    ...
                    <div class="card-body">
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <?php
                                        ...
                                        $sql = "SELECT * FROM `bola_users` WHERE `assign_id`='$assigncode' AND `type`='agent' ";
                                            ...
                                            if(mysqli_num_rows($result) > 0){
                                              ...
                                              echo "<tr>
                                                ...
                                                <div class='dropdown-menu' role='menu' >
                                                  <a  class='dropdown-item' data-toggle='modal' data-target='#modal-primary' id='editBtn' onclick='openRegForm($id)' >Edit</a>
                                                  <a class='dropdown-item' onclick='deleteUser($id)'>Delete</a>
                                                </div>
                                              </div>
  ...
  var openRegForm = async function(ids) {
        ...
        var saveData = async function() {
         ...
         var deleteUser = async function(ids) {
          console.log('data deleted id:' + ids)
          Swal.fire({

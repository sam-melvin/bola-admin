      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item active">Winning Numbers</li>
      ...
      <div class="container-fluid">
        ...
        <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control select2" style="width: 100%;" id="drawAllSlot">
              ...
              <div class="card-body">
                <div class="d-flex">
                  <p class="d-flex flex-column">
                    <span class="text-bold text-lg text-warning" id="totalAllBets">0.00</span>
                  ...
                  <!-- <p class="ml-auto d-flex flex-column text-right">
                    ...
                    <span class="text-muted">Since last month</span>
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody id="dataAllTenStats">
                            <!-- dynamic data here -->
                        </tbody>
                      </table>
                      <br /><br />
                      <a href="primary.php" class="btn btn-primary">Back</a>

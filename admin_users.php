        ...
        <div class="row">
          <div class="col-12">
              <div class="card">
                    ...
                    <h3 class="card-title">Admin Userss</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                      ...
                      <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $wn['code'] ?></td>
                                <td><?php echo $wn['full_name'] ?></td>
                                <td><?php echo $wn['username'] ?></td>
                                <td><?php echo $wn['email'] ?></td>
                                <td><?php echo $wn['phone_no'] ?></td>
                                <td><?php echo $wn['gcash_no'] ?></td>
                                <td><?= $province->getProvince($wn['assign_location']) ?></td>
                                <td><?= $user->statuses[$wn['type']] ?></td>
                                <td>
                                  <?php echo $wn['isOnline'] == '1' ? "<span class='badge badge-warning'>Online" :"<span class='badge badge-danger'>Offline"; ?>
                                  </span>
                                </td>
...
<script type="text/javascript"> 
  $(function () {
    $("#example1").DataTable({
      "responsive": true, "lengthChange": true, "autoWidth": true, "sorter": 1, "order": [[9, 'desc']],

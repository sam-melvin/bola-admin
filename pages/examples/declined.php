...
$apid = $_GET['id'];
$sql = "UPDATE `appointments` SET `appoint_status`='Declined' WHERE id='$apid'";
...
$getsubject = "Declined appointment";
$getmessage = "Sorry, but the request of your appointment on ".$senddatetime." haved been declined";
include("../../../mail1.php");
